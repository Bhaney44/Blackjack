...
label11 = Label(master, text = 'Lucky Hit Card', relief = 'groove', width = 20)
...
def deal():
    ...
    ## String
    face_card_0 = str(face_card)
    face_card_1 = str(face_card_0)
    blank1.insert("1.0", face_card_1, 'r')
    ##Int
    #blank1.insert(face_card)
    ...
    ##Int
    #blank8.insert(удфча_нуль)
    ##String
    удфча_нуль_1 = str(удфча_нуль)
    blank8.insert("1.0", удфча_нуль_1)
    #Insert to blank
    
    удфча_один = random.choice(cards)
    #Int
    ##blank9.insert(удфча_один)
    удфча_один_1 = str(удфча_нуль)
    blank9.insert("1.0", удфча_один_1)
    ##String
    #Insert to blank
    
    добыча = удфча_нуль + удфча_один
    
    #blank11.insert(добыча)
    #blank11.insert("1.0", row, 'r')
    #Insert to blank
