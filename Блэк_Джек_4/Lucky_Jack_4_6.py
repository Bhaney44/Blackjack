...
blank12.grid( row = 12, column = 6, padx = 10 )
...
button0.grid( row = 5, column = 6, columnspan = 1)
button1.grid( row = 6, column = 6, columnspan = 1)
button2.grid( row = 7, column = 6, columnspan = 1)
