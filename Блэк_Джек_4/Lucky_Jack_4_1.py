...
label6.grid( row = 2, column = 1, padx = 10 )
label7.grid( row = 1, column = 1, padx = 10 )

blank1.grid( row = 3, column = 2, padx = 10 )
blank2.grid( row = 2, column = 2, padx = 10 )
blank3.grid( row = 3, column = 2, padx = 10 )
blank4.grid( row = 2, column = 2, padx = 10 )
blank5.grid( row = 3, column = 2, padx = 10 )

#Player
label8.grid( row = 1, column = 1, padx = 10 )
label9.grid( row = 2, column = 1, padx = 10 )
label10.grid( row = 1, column = 1, padx = 10 )
label11.grid( row = 2, column = 1, padx = 10 )
label12.grid( row = 1, column = 1, padx = 10 )

blank7.grid( row = 2, column = 2, padx = 10 )
blank8.grid( row = 3, column = 2, padx = 10 )
blank9.grid( row = 2, column = 2, padx = 10 )
blank10.grid( row = 3, column = 2, padx = 10 )

#Scoreboard
label13.grid( row = 1, column = 1, padx = 10 )
label14.grid( row = 2, column = 1, padx = 10 )
label15.grid( row = 1, column = 1, padx = 10 )
label16.grid( row = 2, column = 1, padx = 10 )
label17.grid( row = 1, column = 1, padx = 10 )

blank11.grid( row = 2, column = 2, padx = 10 )
blank12.grid( row = 3, column = 2, padx = 10 )
blank13.grid( row = 2, column = 2, padx = 10 )
blank14.grid( row = 3, column = 2, padx = 10 )
blank15.grid( row = 3, column = 2, padx = 10 )

button1.grid( row = 9, column = 2, columnspan = 1)
button1.grid( row = 9, column = 2, columnspan = 1)
