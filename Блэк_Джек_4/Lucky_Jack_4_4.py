...
#Scoreboard
label13.grid( row = 4, column = 3, padx = 10 )
#label14.grid( row = 6, column = 3, padx = 10 )
label15.grid( row = 8, column = 3, padx = 10 )
...
blank12.grid( row = 5, column = 3, padx = 10 )
#blank13.grid( row = 7, column = 3, padx = 10 )
blank14.grid( row = 9, column = 3, padx = 10 )
#blank15.grid( row = 4, column = 1, padx = 10 )
#blank16.grid( row = 4, column = 5, padx = 10 )

button0.grid( row = 12, column = 6, columnspan = 1)
button1.grid( row = 13, column = 6, columnspan = 1)
button2.grid( row = 14, column = 6, columnspan = 1)
