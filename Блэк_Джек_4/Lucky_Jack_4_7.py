...
label15 = Label(master, text = 'Prize', relief = 'groove', width = 20)
...
button2 = Button(master, text = 'Buy Chips', relief = 'groove', width = 20, command = buy_chips)
...
blank6.grid( row = 17, column = 2, padx = 10 )

#Player
label8.grid( row = 11, column = 3, padx = 10 )
label9.grid( row = 12, column = 3, padx = 10 )
label10.grid( row = 13, column = 3, padx = 10 )
label11.grid( row = 14, column = 3, padx = 10 )
label12.grid( row = 17, column = 3, padx = 10 )

blank8.grid( row = 12, column = 4, padx = 10 )
blank9.grid( row = 13, column = 4, padx = 10 )
blank10.grid( row = 14, column = 4, padx = 10 )
blank11.grid( row = 17, column = 4, padx = 10 )

#Scoreboard
label13.grid( row = 14, column = 6, padx = 10 )
#label14.grid( row = 6, column = 3, padx = 10 )
label15.grid( row = 16, column = 6, padx = 10 )

label16.grid( row = 1, column = 3, padx = 40 )
#label17.grid( row = 2, column = 3, padx = 30 )
#label18.grid( row = 6, column = 2, padx = 10 )
#label19.grid( row = 6, column = 2, padx = 10 )

blank12.grid( row = 15, column = 6, padx = 10 )
#blank13.grid( row = 7, column = 3, padx = 10 )
blank14.grid( row = 17, column = 6, padx = 10 )
#blank15.grid( row = 4, column = 1, padx = 10 )
#blank16.grid( row = 4, column = 5, padx = 10 )

button0.grid( row = 11, column = 6, columnspan = 1)
button1.grid( row = 12, column = 6, columnspan = 1)
button2.grid( row = 13, column = 6, columnspan = 1)
